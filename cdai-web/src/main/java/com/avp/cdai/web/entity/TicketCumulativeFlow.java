 ...
 */
@Entity
@Table(name = "ticket_cumulative_passenger_flow",schema = "afccd")
public class TicketCumulativeFlow {
    @Id
    private Integer id;
    ...
    public TicketCumulativeFlow(){}

    public TicketCumulativeFlow(Integer ticketId,Long flowCount){
        this.ticketId = ticketId;
